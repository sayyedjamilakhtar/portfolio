...
export default function contact() {
  return (
    <div id="contact" className=" py-[12vh]">
      <div className="w-[95%] md:max-w-[70vw] m-auto text-center">
        <h2 className="text-body-md">Ready to level up your brand?</h2>
        <h3 className="text-fluid-md font-bold my-[.5vh]">
          Let's talk design.
        </h3>
        <p className="text-body-sm md:max-w-[38vw] m-auto">
