    ...
    <div id="services" className="py-[10vh] bg-neutral-900 text-white">
      ...
      <div className="w-[95%] m-auto">
        <div className="max-w-[100vw] mx-auto grid grid-cols-1 md:grid-cols-10 gap-4">
          ...
          <div className="md:col-span-2 row-span-1 min-h-[240px] bg-orange-600 border border-white/10 rounded-xl py-[3vh] px-[2vw]">
            {/* Content goes here */}
          </div>
            ...
            <div className="flex justify-between">
              ...
              <div className="rounded-xl border-1 border-white/20 p-[1vw]">
                <Image
                  ...
                  alt="new"
                />
                <p className="text-center ">Scroll Trigger</p>
              </div>
              <div className="rounded-xl border-1 border-white/20 p-[1vw]">
                <Image
                  className="m-auto mb-[1vh]"
                  ...
                  alt="new"
                />
                <p className="text-center ">Interactive</p>
              </div>
            </div>
          </div>
