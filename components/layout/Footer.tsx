...
export default function Footer() {
  return (
    <div className="h-[90vh] py-[10vh] bg-neutral-900 text-white overflow-hidden">
      <div className="w-[95%] pb-[15vh] m-auto grid grid-cols-3">
        {/* email part  */}
        <div>
          ...
          <a href="mailto:sayyedjamilakhtar@gmail.com">
            <span className="relative group cursor flex flex-col items-center gap-[0.5vw] text-[1vw] inline-flex">
              <span className="text-[3vw] font-normal group-hover:text-neutral-400">
      ...
      <div className="w-[100%] m-auto -mt-[4vh]">
